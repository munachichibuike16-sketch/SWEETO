...
export const translations = {
  en: {
    // Header & Nav
    home: "Store", saved: "Saved", profile: "Profile", me: "Me", cart: "Cart",
  ...
  fr: {
    // Header & Nav
    home: "Boutique", saved: "Enregistré", profile: "Profil", me: "Moi", cart: "Panier",
    ...
    // Products & Cart
    view_all: "Voir Tout", add_to_cart: "Ajouter au Panier", out_of_stock: "Épuisé", in_stock: "En Stock",
    your_cart: "Votre Panier", checkout: "Commander", total: "Total", empty_cart: "Votre panier est vide",
    continue_shopping: "Continuer les Achats", subtotal: "Sous-total", taxes_calculated: "Taxes calculées à la caisse",
    remove: "Retirer", color: "Couleur", size: "Taille", quantity: "Quantité", description: "Description", features: "Caractéristiques", reviews: "Avis",
    ...
    premium_material_desc: "Nos maîtres artisans ont conçu ce produit en utilisant uniquement les matériaux haut de gamme les plus raffinés. Chaque composant est méticuleusement testé pour s'assurer qu'il répond à nos normes rigoureuses d'excellence et de durabilité.",
    ...
    premium_edition: "Édition Premium", sold: "Vendu", discover_product: "Découvrir", buy_now: "Acheter Maintenant",
    feedback: "Avis Clients", global_intel: "Intelligence Globale", community_rating: "Note de la Communauté",
    leave_review: "Laissez votre avis", share_experience: "Partagez votre expérience...", submit_experience: "Soumettre l'Avis",
    related: "Produits Similaires", you_might_also_like: "Vous Pourriez Aussi Aimer", curated_for_you: "Sélection Pour Vous",
    verified_authentic: "Stock Authentique Vérifié", login_now: "Connectez-vous pour continuer", products: "Produits",
    premium_items: "Articles Premium", select_gear: "Sélectionnez votre équipement", local_handling: "Manutention Locale", gratis: "GRATUIT",
    ...
    about_hub: "Qui Sommes-Nous",
    about_desc: "SWEETO-HUB est votre boutique d'électronique haut de gamme de confiance à Abidjan. Nous importons le meilleur de la technologie mondiale directement chez vous.",
    ...
    exclusive_daily_discounts: "Offres Éclairs du Jour",
    ...
    welcome_hub: "Bienvenue au Hub", check_inbox: "Consultez votre boîte de réception pour des offres exclusives",
    // Categories & Sort
    our_top_categories: "Nos Meilleures Catégories",
    explore_curated: "Explorez les produits sélectionnés par départements premium",
    ...
    sort_by: "Trier par :", name_az: "Nom (A-Z)", price_low_high: "Prix : Croissant", price_high_low: "Prix : Décroissant", latest_arrivals: "Derniers Arrivages",
    back: "Retour", discovery: "Découverte", deal_of_day: "Offre du Jour", featured_items: "Articles en Vedette",
    ...
    discover_full_range: "Découvrez Toute Notre Gamme", recently_viewed: "Vus Récemment", tech_history: "Votre Historique Tech",
    featured: "En vedette", shop_now: "Acheter",
    refine_selection: "Affiner la sélection", all: "Tout",
    // Product Dictionary
    premium_noise_cancelling_headphones: "Casque antibruit premium",
    pro_gaming_mouse: "Souris gaming pro",
    ergonomic_mechanical_keyboard: "Clavier mécanique ergonomique",
    ultra_slim_laptop: "Ordinateur ultra-fin",
    smart_home_hub: "Hub domotique intelligent",
    // Common Categories & Brands
    headphones: "Casques & Écouteurs", smartphones: "Smartphones", laptops: "Ordinateurs Portables", storage_drives: "Stockage",
    external_cases: "Boîtiers Externes", accessories: "Accessoires", gaming: "Jeux Vidéo", audio: "Audio",
    wearables: "Objets Connectés", appliances: "Électroménager", networking: "Réseau",
    storage_drives: "Lecteurs de Stockage", desktops: "Ordinateurs de Bureau", components: "Composants",
    // Brands
    bose: "Bose", samsung: "Samsung", sony: "Sony", apple: "Apple", dell: "Dell", hp: "HP",
    lenovo: "Lenovo", asus: "Asus", logitech: "Logitech",
    // Custom Section & Category Labels
    ...
    home_cinema: "Home Cinéma", tv_video: "TV & Vidéo", smart_watch: "Montre Connectée",
    power_bank: "Batterie Externe", cables: "Câbles", printers: "Imprimantes",
    // Section Subtitle Phrases
    most_popular_on_our_network: "Le Plus Populaire de Notre Réseau",
    the_latest_in: "Les Derniers en", popular_choices_in: "Choix Populaires en", the_best_of: "Le Meilleur de",
    trending_now: "Tendances Actuelles", new_arrival: "Nouvel Arrivage", just_in: "Tout Juste Arrivé",
    top_picks_for_you: "Sélection pour Vous",
    // Wishlist & Checkout
    wishlist_empty: "Votre liste de souhaits est vide", wishlist_empty_desc: "Votre collection organisée vous attend. Explorez notre inventaire premium et enregistrez vos favoris ici.",
    explore_products: "Commencer la découverte", saved_gear: "Équipement Sauvegardé", item: "Article", items: "Articles",
    ...
    will_contact_you: "vous contactera bientôt au", to_confirm_delivery: "pour confirmer l'heure de livraison.",
    payment_method: "Mode de Paiement", cash_on_delivery: "Paiement à la Livraison", back_to_shop: "Retour à la Boutique",
    back_to_cart: "Retour au Panier", delivery_details: "Détails de Livraison", where_send_package: "Où devons-nous envoyer votre colis ?",
    recipient_name: "Nom du Destinataire", eg_name: "ex. Yao Kouassi", contact_phone: "Téléphone",
    city: "Ville", precise_address: "Adresse Précise", address_placeholder: "Quartier, Bâtiment, Porte",
    pay_on_delivery: "Paiement à la Livraison", payment_collected_doorstep: "Le paiement sera perçu à votre porte",
    agree_to_pay: "J'accepte de payer à la livraison et j'accepte les", store_policies: "Politiques du Magasin",
    email_me_updates: "M'envoyer par email les mises à jour", placing_order: "Passation...",
    ...
    estimated_delivery: "Livraison Estimée", quality_guarantee: "Qualité Garantie", express_delivery: "Livraison Express",
  ...
  es: {
    // Header & Nav
    home: "Tienda", saved: "Guardado", profile: "Perfil", me: "Yo", cart: "Carrito",
  ...
  de: {
    home: "Shop", saved: "Gespeichert", profile: "Profil", me: "Ich", cart: "Warenkorb",
  ...
  it: {
    home: "Negozio", saved: "Salvato", profile: "Profilo", me: "Io", cart: "Carrello",
  ...
  pt: {
    home: "Loja", saved: "Salvo", profile: "Perfil", me: "Eu", cart: "Carrinho",
  ...
  ar: {
    home: "المتجر", saved: "محفوظ", profile: "الملف الشخصي", me: "أنا", cart: "السلة",
  ...
  zh: {
    home: "商店", saved: "已保存", profile: "资料", me: "我", cart: "购物车",
  ...
  ja: {
    home: "ストア", saved: "保存", profile: "プロフ", me: "私", cart: "カート",
  ...
  hi: {
    home: "स्टोर", saved: "सहेजा गया", profile: "प्रोफ़ाइल", me: "मैं", cart: "कार्ट",
  ...
  ru: {
    home: "Магазин", saved: "Сохранено", profile: "Профиль", me: "Я", cart: "Корзина",
