...
export const translations = {
  en: {
    ...
    privacy: "Privacy", terms: "Terms", security: "Security", refund: "Refunds",
  ...
  fr: {
    ...
    privacy: "Confidentialité", terms: "Conditions", security: "Sécurité", refund: "Retours & Remboursements",
  ...
  es: {
    ...
    privacy: "Privacidad", terms: "Términos", security: "Seguridad", refund: "Reembolsos",
  ...
  de: {
    ...
    privacy: "Datenschutz", terms: "Bedingungen", security: "Sicherheit", refund: "Rückerstattungen",
  ...
  it: {
    ...
    privacy: "Privacy", terms: "Termini", security: "Sicurezza", refund: "Rimborsi",
  ...
  pt: {
    ...
    privacy: "Privacidade", terms: "Termos", security: "Segurança", refund: "Reembolsos",
  ...
  ar: {
    ...
    privacy: "الخصوصية", terms: "الشروط", security: "الأمان", refund: "الاسترجاع والاسترداد",
  ...
  zh: {
    ...
    privacy: "隐私", terms: "条款", security: "安全", refund: "退款政策",
  ...
  ja: {
    ...
    privacy: "プライバシー", terms: "利用規約", security: "セキュリティ", refund: "返金ポリシー",
  ...
  hi: {
    ...
    privacy: "गोपनीयता", terms: "शर्तें", security: "सुरक्षा", refund: "वापसी और धनवापसी",
  ...
  ru: {
    ...
    privacy: "Конфиденциальность", terms: "Условия", security: "Безопасность", refund: "Возврат и возмещение",
