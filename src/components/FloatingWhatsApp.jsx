...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      onClick={handleClick}
      className="fixed bottom-20 left-6 sm:bottom-6 sm:left-6 z-[90] p-3.5 sm:p-4 bg-[#25D366] text-white shadow-[0_10px_35px_rgba(37,211,102,0.45)] rounded-full hover:bg-[#20ba5a] cursor-pointer flex items-center justify-center group"
