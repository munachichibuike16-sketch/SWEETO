        ...
        <div className="main-container max-w-[500px] w-full relative z-10">
          <div className="auth-card dark:bg-eas-dark/60 dark:border-white/5 backdrop-blur-xl">
            ...
            <div className="relative w-full max-w-[320px] mx-auto min-h-[46px] my-3 flex justify-center items-center">
              ...
              <button 
                type="button"
                className="btn-google w-full h-full flex items-center justify-center gap-2 absolute inset-0 z-0 border border-slate-200 dark:border-white/10 dark:bg-white/5 rounded-full"
              ...
              {/* Official Google sign-in container on top with high transparency */}
              {googleLoaded && (
                <div 
                  id="google-button-official" 
                  className="w-full h-full flex justify-center absolute inset-0 z-10 opacity-[0.02]" 
                />
              )}
            </div>
